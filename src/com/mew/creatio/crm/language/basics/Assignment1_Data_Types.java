package com.mew.creatio.crm.language.basics;

public class Assignment1_Data_Types {
	...
	public static void main(String[] args) 
	{
	   ...
	   double a = 37.7749;
	   double b = -122.4194;
	   System.out.println("6. Coordinates of a location (latitude, longitude):" + a +"," + b);
	   
	   //7. Person's marital status: true or false
	   boolean status=false;
	   System.out.println("7. Person's marital status: true or false :" + status);
	   ...
	   String colour="Blue";
	   System.out.println("9. Person's favourite colour: " + colour);
	   ...
	   int follow = 100000;
	   System.out.println("11. Number of followers on a social media platform:" + follow);  
	   
	   //12. Rating of a movie: 7.5
	   float movie=7.5f;
	   System.out.println("12. Rating of a movie:" + movie);
	   
	   //13. Person's blood type: 'A'
	   char blood='A';
	   System.out.println("13. Person's blood type:" + blood);
	   
	   //14.Title of a book: "To Kill a Mockingbird"
	   String title="To Kill a Mockingbird";
	   System.out.println("14. Title of a book:" + title);
	   
	   //15.Number of employees in a company: 500
	   int no_of_employee=500;
	   System.out.println("15. Number of employees in a company:" + no_of_employee);
	   
	   //16.Time of an event: 2:30 PM
	   String eventTime = "2:30 PM";
	   System.out.println("16. Time of the event: " + eventTime);
